...
re = model.process_depth(image, prompt=prompt, num_images=1, additional_prompt=prompt, negative_prompt=n_prompt, image_resolution=840, preprocess_resolution=512,num_steps=25, guidance_scale=7.0, seed=100, preprocessor_name='Midas', callback=progress)#
